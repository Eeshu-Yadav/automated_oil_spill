...
import {
  ...
  useTheme,
  useThemeProps
} from "./chunk-3NY2LSYP.js";
import {
  _extends,
  _objectWithoutPropertiesLoose,
  clsx_default,
  require_prop_types
} from "./chunk-7WXJUCHB.js";
import {
  require_jsx_runtime
...
function InteractionProvider(props) {
  ...
  return (0, import_jsx_runtime2.jsx)(InteractionContext.Provider, {
    value,
    children
  });
}
...
function CartesianProvider(props) {
  ...
  const xValues = React18.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: xAxis,
  ...
  const yValues = React18.useMemo(() => computeValue({
    drawingArea,
    formattedSeries,
    axis: yAxis,
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime7.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: colorMap.thresholds.map((threshold2, index) => {
      ...
      return (0, import_jsx_runtime7.jsxs)(React23.Fragment, {
        children: [(0, import_jsx_runtime7.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime8.jsx)("linearGradient", {
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime8.jsx)("stop", {
        offset,
        stopColor: color,
        stopOpacity: 1
      }, keyPrefix + index);
...
function useChartGradient() {
  ...
  return React25.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime9.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime9.jsx)(ChartsPiecewiseGradient, {
          isReversed: !reverse,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime9.jsx)(ChartsContinuousGradient, {
          isReversed: !reverse,
          scale,
          colorScale,
          colorMap,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React27.useContext(HighlightedContext);
  if (!isInitialized) {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React29.useMemo(() => {
  ...
  const providerValue = React29.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
  ...
  return (0, import_jsx_runtime10.jsx)(HighlightedContext.Provider, {
    value: providerValue,
    children
  });
}
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React30.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React31.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React31.createContext(init));
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const mousePosition = React32.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var _excluded2 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
...
var ChartsSurface = React33.forwardRef(function ChartsSurface2(inProps, ref) {
  ...
  return (0, import_jsx_runtime11.jsxs)(ChartChartsSurfaceStyles, _extends({
    ...
    children: [(0, import_jsx_runtime11.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime11.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React35.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React35.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(StyledText, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime30.jsx)(StyledText2, _extends({
    x: left + width / 2,
    y: top + height / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime31.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime31.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
react-is/cjs/react-is.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-6Y2JS3EG.js.map
